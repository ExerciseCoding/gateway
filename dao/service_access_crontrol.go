...
type AccessControl struct {
	...
	ServiceID         int64  `json:"service_id" gorm:"colum:service_id" description:"服务id"`
	OpenAuth          int    `json:"open_auth" gorm:"column:open_auth" description:"是否开启权限 1=开启"`
	BlockList         string `json:"black_list" gorm:"column:black_list" description:"黑名单ip"`
...
func (t *AccessControl) ListBYServiceID(c *gin.Context, tx *gorm.DB, serviceID int64) ([]AccessControl, int64, error) {
	...
	var count int64
	query := tx.SetCtx(public.GetGinTraceContext)
